...
config.proxy.container_prefix   = process.env.PEOPLE_CONTAINER_PREFIX           || 'people_user-';
config.proxy.labels_prefix      = process.env.PEOPLE_CONTAINER_LABELS_PREFIX    || os.hostname();
config.proxy.cmd                = process.env.PEOPLE_CMD                        || './startup.sh';
config.proxy.wait_after_refused = 50;
